...
class DataExtractor(DatabaseConnector):
    ...
    def list_number_of_stores(self):
        ...
        n_s = requests.get('https://aqj7u5id95.execute-api.eu-west-1.amazonaws.com/prod/number_stores', headers= self.headers)
        return n_s.text

    def retrieve_stores_data(self):
        self.base_url = 'https://aqj7u5id95.execute-api.eu-west-1.amazonaws.com/prod/store_details/'
        self.response_list = []
        self.df_list = []
